...
categories: []
arxiv_url: https://arxiv.org/abs/2401.05314
source: arxiv-html
converter: pandoc
...
| IWSLT 2023 \[1\]  | 5         | 200        | DE $`\rightarrow`$ EN     | DE Text      | EN Translation           | $`✓`$/$`\times`$      |
| MuST-C \[2\]      | $`> 385`$ | $`> 211`$K | X (8) $`\rightarrow`$ EN  | Spoken Audio | Subtitles                | $`\times`$/$`\times`$ |
| MSLT \[3\]        | 4         | 3K         | FR/DE $`\rightarrow`$ EN  | Audio        | Translations             | $`\times`$/$`\times`$ |
| MuST-Cinema \[4\] | $`> 385`$ | $`> 211`$K | X (7) $`\rightarrow`$ EN  | Spoken Audio | Subtitles                | $`✓`$/$`\times`$      |
| Heroes \[5\]      | 5         | 7K         | ES $`\leftrightarrow`$ EN | Spoken Audio | Spoken Audio             | $`✓`$/$`✓`$           |
| Anim-400K (Ours)  | 763       | 425K       | JP $`\leftrightarrow`$ EN | Spoken Audio | Spoken Audio + Subtitles | $`✓`$/$`✓`$           |
...
Recently, there has been significant scientific interest in summarizing and describing video as natural language descriptions of video have the potential to aid in accessibility, content understanding and generation, recommendation algorithms and information retrieval domains (among others) \[31\]. Unfortunately, for long-form videos ($`> {30s}`$), data for such summarization tools is largely unavailable. To help remedy this, in addition to the aligned video clips, Anim-400K contains 3.5K human-generated short ($`62.85 \pm 61.99`$ word) teaser summaries of selected episodes, designed to describe the contents of the video to a potential watcher, and entice them to watch the video. While this data may not be enough to allow for training summarization models, it can support the evaluation of video summarization and teaser generation tools.

### 3.0.0.2 (3.2) Character Identification & Description:

Understanding, locating, and naming characters within larger properties is a challenging task, for which data support is generally lacking. These tasks can often form the backbone of complex visual description, search, and analysis systems. In order to support tasks such as character re-identification \[32\] and character description \[33\], we additionally collect short descriptions (on average $`109.77 \pm 142.89`$ words) for 1828 characters across the 190 represented shows, as well as 7516 still images of each of these characters. This augmentation to Anim-400K aims to provide scholars with valuable resources to advance character-related research and applications, contributing to the broader field of multimedia analysis.

### 3.0.0.3 (3.3) Genre/Theme/Style Identification:

Understanding the genres, themes, and styles present in animated video can have several applications, including content recommendation, audience targeting and content analysis among others. To support research in these domains, in addition to collecting the shows themselves, in Anim-400K, each show is labeled with at least one of 18 genres, and can contains up to 44 themes. The distributions across the most common themes are shown in Figure 2 Genre/Theme/Style Identification: ‣ 3 Supported Secondary Tasks ‣ Anim-400K: A Large-Scale Dataset for Automated End to End Dubbing of Video"). There are an average of $`2.84 \pm 1.29`$ genres, and an average of $`1.64 \pm 0.99`$ themes per show. In addition to the simple classification tasks enabled by labeling with genre and themes, Anim-400K can support both the problem of art style classification, the process of determining if two images are from the same anime/series/studio, and art style transfer, the process of transferring images between styles, both of which have been well studied in prior work \[34, 35\]. Individual frames in Anim-400K extracted at a rate of 1FPS provides 2.3M images across the 190 properties in the dataset.
...
- Agrawal et al. \[2023\] S. Agrawal _et al._, “Findings of the iwslt 2023 evaluation campaign,” in _IWSLT_, 2023, pp. 1–61.
- Di Gangi et al. \[2019\] M. A. Di Gangi _et al._, “Must-c: a multilingual speech translation corpus,” in _NAACL: Human Language Technologies_.   Association for Computational Linguistics, 2019, pp. 2012–2017.
- Federmann and Lewis \[2016\] C. Federmann and W. Lewis, “Microsoft speech language translation (mslt) corpus: The iwslt 2016 release for english, french and german,” in _Proceedings of the 13th International Conference on Spoken Language Translation_, 2016.
- Karakanta et al. \[2020\] A. Karakanta, M. Negri, and M. Turchi, “Must-cinema: a speech-to-subtitles corpus,” _arXiv:2002.10829_, 2020.
- Öktem et al. \[2018\] A. Öktem _et al._, “Bilingual prosodic dataset compilation for spoken language translation,” _IberSpeech_, 2018.
- Yang et al. \[2020\] Y. Yang _et al._, “Large-scale multilingual audio visual dubbing,” _arXiv:2011.03530_, 2020.
- Agency \[2023\] C. I. Agency, “World,” The World Factbook, 2023. \[Online\]. Available: [https://www.cia.gov/the-world-factbook](https://www.cia.gov/the-world-factbook)
- Koolstra et al. \[2002\] C. M. Koolstra, A. L. Peeters, and H. Spinhof, “The pros and cons of dubbing and subtitling,” _European Journal of Communication_, vol. 17, no. 3, pp. 325–354, 2002.
- Wissmath et al. \[2009\] B. Wissmath, D. Weibel, and R. Groner, “Dubbing or subtitling? effects on spatial presence, transportation, flow, and enjoyment,” _Journal of Media Psychology_, vol. 21, no. 3, pp. 114–125, 2009.
- Boonyubol et al. \[2022\] S. Boonyubol, S. Kabir, and J. S. Cross, “Comparing mooc learners engagement with japanese videos and text to speech generated english videos,” in _Proceedings of the Ninth ACM Conference on Learning@ Scale_, 2022, pp. 317–320.
- Wu et al. \[2023\] Y. Wu _et al._, “Videodubber: Machine translation with speech-aware length control for video dubbing,” in _Proceedings of the AAAI Conference on Artificial Intelligence_, vol. 37, no. 11, 2023, pp. 13 772–13 779.
- Öktem et al. \[2019\] A. Öktem, M. Farrús, and A. Bonafonte, “Prosodic Phrase Alignment for Machine Dubbing,” in _Proc. Interspeech 2019_, 2019, pp. 4215–4219.
- Effendi et al. \[2022\] J. Effendi, Y. Virkar, R. Barra-Chicote, and M. Federico, “Duration modeling of neural tts for automatic dubbing,” in _ICASSP_.   IEEE, 2022, pp. 8037–8041.
- Lakew et al. \[2021\] S. M. Lakew _et al._, “Machine translation verbosity control for automatic dubbing,” in _ICASSP_.   IEEE, 2021, pp. 7538–7542.
- Lakew et al. \[2022\] S. M. Lakew, Y. Virkar, P. Mathur, and M. Federico, “Isometric mt: Neural machine translation for automatic dubbing,” in _ICASSP_.   IEEE, 2022, pp. 6242–6246.
- Tam et al. \[2021\] D. Tam, S. M. Lakew, Y. Virkar, P. Mathur, and M. Federico, “Isochrony-aware neural machine translation for automatic dubbing,” _arXiv:2112.08548_, 2021.
- Virkar et al. \[2021\] Y. Virkar, M. Federico, R. Enyedi, and R. Barra-Chicote, “Improvements to prosodic alignment for automatic dubbing,” in _ICASSP_.   IEEE, 2021, pp. 7543–7574.
- Brannon et al. \[2023\] W. Brannon, Y. Virkar, and B. Thompson, “Dubbing in practice: A large scale study of human localization with insights for automatic dubbing,” _ACL_, vol. 11, pp. 419–435, 2023.
- Yang et al. \[2017\] X. Yang, Y.-N. Chen, D. Hakkani-Tür, P. Crook, X. Li, J. Gao, and L. Deng, “End-to-end joint learning of natural language understanding and dialogue manager,” in _ICASSP_.   IEEE, 2017, pp. 5690–5694.
- Swiatkowski et al. \[2023\] J. Swiatkowski _et al._, “Cross-lingual prosody transfer for expressive machine dubbing,” _arXiv:2306.11658_, 2023.
- Federico et al. \[2020\] M. Federico _et al._, “Evaluating and optimizing prosodic alignment for automatic dubbing,” 2020.
- Singh et al. \[2023\] N. Singh _et al._, “Looking similar, sounding different: Leveraging counterfactual cross-modal pairs for audiovisual representation learning,” _arXiv:2304.05600_, 2023.
- Chafe and Tannen \[1987\] W. Chafe and D. Tannen, “The relation between written and spoken language,” _Annual review of anthropology_, vol. 16, no. 1, pp. 383–407, 1987.
- Öktem et al. \[2017\] A. Öktem, M. Farrús, and L. Wanner, “Automatic extraction of parallel speech corpora from dubbed movies,” in _BUCC_.   ACL (Association for Computational Linguistics), 2017.
- Bredin et al. \[2021\] H. Bredin _et al._, “End-to-end speaker segmentation for overlap-aware resegmentation,” in _Proc. Interspeech 2021_, 2021.
- Hennequin et al. \[2020\] R. Hennequin, A. Khlif, F. Voituret, and M. Moussallam, “Spleeter: a fast and efficient music source separation tool with pre-trained models,” _Journal of Open Source Software_, 2020, deezer Research.
- Schinkel-Bielefeld et al. \[2012\] N. Schinkel-Bielefeld, N. Lotze, and F. Nagel, “Does understanding of test items help or hinder subjective assessment of basic audio quality?” in _Audio Engineering Society Convention 133_.   Audio Engineering Society, 2012.
...
- Casanova et al. \[2022\] E. Casanova _et al._, “Yourtts: Towards zero-shot multi-speaker tts and zero-shot voice conversion for everyone,” in _International Conference on Machine Learning_.   PMLR, 2022, pp. 2709–2720.
- Meena et al. \[2023\] P. Meena, H. Kumar, and S. K. Yadav, “A review on video summarization techniques,” _Engineering Applications of Artificial Intelligence_, vol. 118, p. 105667, 2023.
- Kurt and Özkan \[2017\] Z. Kurt and K. Özkan, “An image-based recommender system based on feature extraction techniques,” in _UBMK_.   IEEE, 2017, pp. 769–774.
- Gan et al. \[2017\] C. Gan _et al._, “Stylenet: Generating attractive visual captions with styles,” in _CVPR_, 2017, pp. 3137–3146.
- Li et al. \[2022\] H. Li, S. Guo, K. Lyu, X. Yang, T. Chen, J. Zhu, and H. Zeng, “A challenging benchmark of anime style recognition,” in _CVPR_, 2022, pp. 4721–4730.
- Li et al. \[2023\] Z. Li, Y. Xu, N. Zhao, Y. Zhou, Y. Liu, D. Lin, and S. He, “Parsing-conditioned anime translation: A new dataset and method,” _ACM Transactions on Graphics_, vol. 42, no. 3, pp. 1–14, 2023.
- Tu et al. \[2021\] Z. Tu _et al._, “Rapique: Rapid and accurate video quality prediction of user generated content,” _IEEE Open Journal of Signal Processing_, vol. 2, pp. 425–440, 2021.
