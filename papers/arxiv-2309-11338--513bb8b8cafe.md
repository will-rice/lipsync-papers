...
url: https://arxiv.org/abs/2309.11338
source: arxiv
doi: null
arxiv_id: '2309.11338'
categories: []
...
- Bahar et al. (2020) Parnia Bahar, Tobias Bieschke, Ralf Schlüter, and Hermann Ney. 2020. [Tight integrated end-to-end training for cascaded speech translation](http://arxiv.org/abs/2011.12167). _CoRR_, abs/2011.12167.
- Chen et al. (2022a) Shiyu Chen, Yawen Zeng, Da Cao, and Shaofei Lu. 2022a. [Video-guided machine translation via dual-level back-translation](https://doi.org/https://doi.org/10.1016/j.knosys.2022.108598). _Knowledge-Based Systems_, 245:108598.
- Chen et al. (2022b) Shiyu Chen, Yawen Zeng, Da Cao, and Shaofei Lu. 2022b. [Vision talks: Visual relationship-enhanced transformer for video-guided machine translation](https://doi.org/https://doi.org/10.1016/j.eswa.2022.118264). _Expert Systems with Applications_, 209:118264.
- Chung and Zisserman (2017) Joon Son Chung and Andrew Zisserman. 2017. Out of time: Automated lip sync in the wild. In _Computer Vision – ACCV 2016 Workshops_, pages 251–263, Cham. Springer International Publishing.
...
- Huang et al. (2017) Zhiwu Huang, Bernhard Kratzwald, Danda Pani Paudel, Jiqing Wu, and Luc Van Gool. 2017. Face translation between images and videos using identity-aware cyclegan. _arXiv preprint arXiv:1712.00971_.
- Jha et al. (2019) Abhishek Jha, Vikram Voleti, Vinay Namboodiri, and C. V. Jawahar. 2019. [Cross-language speech dependent lip-synchronization](https://doi.org/10.1109/ICASSP.2019.8682275). In _ICASSP 2019 - 2019 IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)_, pages 7140–7144.
- K R et al. (2019) Prajwal K R, Rudrabha Mukhopadhyay, Jerin Philip, Abhishek Jha, Vinay Namboodiri, and C V Jawahar. 2019. [Towards automatic face-to-face translation](https://doi.org/10.1145/3343031.3351066). In _Proceedings of the 27th ACM International Conference on Multimedia_, MM ’19, page 1428–1436, New York, NY, USA. Association for Computing Machinery.
- Pearson (1895) Karl Pearson. 1895. Note on Regression and Inheritance in the Case of Two Parents. _Proceedings of the Royal Society of London Series I_, 58:240–242.
- Prajwal et al. (2020a) K R Prajwal, Rudrabha Mukhopadhyay, Vinay P. Namboodiri, and C.V. Jawahar. 2020a. [A lip sync expert is all you need for speech to lip generation in the wild](https://doi.org/10.1145/3394171.3413532). In _Proceedings of the 28th ACM International Conference on Multimedia_, MM ’20, page 484–492, New York, NY, USA. Association for Computing Machinery.
- Prajwal et al. (2020b) KR Prajwal, Rudrabha Mukhopadhyay, Vinay P Namboodiri, and CV Jawahar. 2020b. Learning individual speaking styles for accurate lip to speech synthesis. In _Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition_, pages 13796–13805.
- Ritter et al. (1999) Max Ritter, Uwe Meier, Jie Yang, and Alex Waibel. 1999. Face translation: A multimodal translation agent. In _AVSP’99-International Conference on Auditory-Visual Speech Processing_.
- Rosenzweig et al. (2021) Sebastian Rosenzweig, Simon Schwär, Jonathan Driedger, and Meinard Müller. 2021. Adaptive pitch-shifting with applications to intonation adjustment in a cappella recordings. In _2021 24th International Conference on Digital Audio Effects (DAFx)_, pages 121–128. IEEE.
