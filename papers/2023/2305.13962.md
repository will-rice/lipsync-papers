...
| *I* | *II* | *III* | SSIM $`\uparrow`$ | PSNR $`\uparrow`$ | FVD $`\downarrow`$ | LSE-C $`\uparrow`$ | LSE-D $`\downarrow`$ |
|----|----|----|----|----|----|----|----|
...
TABLE II: Ablation studies for proposed individual components: densely-connected generator (*I*), CLIP-based attention condenser (*II*) and probability map constraints (*III*).
