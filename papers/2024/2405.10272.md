...
citations_resolved_at: "2026-07-07T14:20:26+00:00"
references_parsed: 0
arxiv_version: ""
---
...
Figure 3: The architecture of the audio mapper. The _condition_ denotes the concatenated feature of text embedding $`{\mathbf{e}}_{t}`$, upsampled text feature $`{\overset{\sim}{f}}_{t}`$, and energy, which is a norm of $`{\overset{\sim}{f}}_{t}`$.
